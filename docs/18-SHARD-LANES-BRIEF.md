# 18: Shard-lanes brief (Fable, 2026-07-17, binding)
...
2. **Post-normalize tolerance ±0.5%** per congress: per-lane statement counts will NOT sum precisely
...
4. Suite green (259+), plus new failure fixtures: per-lane loader for 107–112 raises; unknown lane
...
2021-01-03, so the right-censor guard (`censor_days`) applies at the lane edge precisely as it does at
