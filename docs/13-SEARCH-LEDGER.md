...
| S1.4 | The Copy-Paste Caucus (verbatim floor) | **REFUTED** (asymmetric) | D verbatim share **0.0004→~0.009 (~20×, both halves rising)**; R rose then fell (R_B −1) | 2026-07-15 | Not both-parties-rising → REFUTED. But **Democrats' verbatim copy-paste rose sharply, Republicans' didn't** — and D's spike (2023–25) coincides with D being House **minority**, a ⚠ power-position candidate (minority copy-pastes more?) that also rhymes with S1.9. Verbatim byte-identical is density-robust but rare (tiny rates); the FUZZY near-identical metric (`s1_4_proper`, heavy re-normalize) is the deeper follow-up. Reframe check required before publishing the asymmetry. |
